...
import belgrays.android_app.my_econ.databinding.ActivityShowTaskBinding;

public class ShowTaskActivity extends AppCompatActivity {
    private ActivityShowTaskBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityShowTaskBinding.inflate(getLayoutInflater());
